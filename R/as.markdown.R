...
#' Function to transform bioacousticsquote objects to strings suitable for markdown
#'
#' This function coerces bioacousticsquote objects to strings suitable for rendering in markdown.
...
#'
#' This function formats a bioacousticsquote object to the tagged \code{key:value} format used for
#' maintaining the bioacousticsquotes database.  The key names are:
#' \preformatted{
